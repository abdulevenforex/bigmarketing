 ...
 */
class Address extends \User\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'line1', 'line2', 'city', 'country', 'zipcode', 'inputFilter', 'id', 'rawdata');
        }
